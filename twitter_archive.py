...
# to harvest a particular user's tweets, set hashtag = "from: username"
# example: "from: markhamill"

# to harvest a particular hashtag, set hastag = "#hastag" 
# example: "#starwars"
        ...
        if data["meta"]["result_count"] == 0:
            ...
            for element in tweets:
                try:
                    ...
                    if len(mentions_string) > 0 or mentions_string is None:
